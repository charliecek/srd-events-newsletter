...
if (empty($aSelectedCategoryIds)) {
    $aSelectedCategoryIds = array();
}
if (empty($aSelectedTagIds)) {
    $aSelectedTagIds = array();
}
...
?>
    ...
    <table id="mainStructure" width="800" class="full-width" align="center" border="0" cellspacing="0" cellpadding="0"
           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #efefef;width: 800px;max-width: 800px;outline: rgb(239, 239, 239) solid 1px;box-shadow: rgb(224, 224, 224) 0px 0px 5px;margin: 0px auto;">
        <tbody>
        <tr>
            <td align="center" valign="top" class="container" id="td_8cbd_0" bgcolor="#eef0f3"
                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;background-color: #eef0f3;">
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                       id="table_8cbd_0"
                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #eef0f3;min-width: 600px;width: 600px;margin: 0px auto;">
                    <tbody>
                    <tr>
                        <td valign="top" align="center"
                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                            <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                   class="full-width"
                                   id="table_8cbd_1"
                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                <tbody>
                                <tr>
                                    <td valign="top" height="3" id="td_8cbd_1"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 3px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" id="td_8cbd_2"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 300;text-align: right;word-break: break-word;line-height: 22px;">
                                        <div id="div_8cbd_0"
                                             style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;text-align: right;font-size: 14px;">
                                <span id="span_8cbd_0" style="line-height: 20px;font-size: 12px;">
                                    ...
                                    <a href="{email_url}" id="a_8cbd_0"
                                       style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;color: #6689ac;border-style: none;text-decoration: none !important;">
                                      kliknite sem.
                                    </a>
                                </span>
                                        </div>
                                ...
                                <tr>
                                    <td valign="top" height="1" id="td_8cbd_3"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 1px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"
                                        ...
                                        <table width="auto" border="0" align="center" cellpadding="0" cellspacing="0"
                                               id="table_8cbd_2"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                            <tbody>
                                            <tr>
        ...
        <tr>
            <td align="center" valign="top" class="container" id="td_8cbd_5" bgcolor="#eef0f3"
                ...
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                       id="table_8cbd_3"
                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #ffffff;min-width: 600px;width: 600px;margin: 0px auto;">
                    <tbody>
                    <tr>
                        <td valign="top"
                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tbody>
                                <tr>
                                    <td align="center" valign="middle" class="image-full-width" width="600"
                                        id="td_8cbd_6"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 600px;">
                                        <img src="<?php echo $theme_url; ?>/images/20170126185928_news_top_1.jpg"
                                             width="600" id="img_8cbd_0" alt="image" border="0" hspace="0" vspace="0"
                                             height="auto"
                                             style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 600px;width: 600px;height: auto !important;display: block !important;">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
        ...
        <tr>
            <td align="center" valign="top" class="container" id="td_8cbd_7" bgcolor="#eef0f3"
                ...
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                       id="table_8cbd_5"
                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;min-width: 600px;background-color: #eef0f3;width: 600px;margin: 0px auto;">
                    <tbody>
                    <tr>
                        <td valign="top" align="center"
                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                            <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" class="image-full-width" width="560" id="td_8cbd_8"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 560px;">
                                        <img src="<?php echo $theme_url; ?>/images/shadow-space2.png" width="560"
                                             alt="shadow-space" id="img_8cbd_1" border="0" hspace="0" vspace="0"
                                             style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 560px;height: auto !important;display: block!important;">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top" height="8" id="td_8cbd_9"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 8px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" height="9" id="td_8cbd_11"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 9px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" id="td_8cbd_12"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 300;text-align: center;word-break: break-word;line-height: 22px;">
                            <span id="span_8cbd_1" style="text-decoration: none;">
                                ...
                                <tr>
                                    <td valign="top" height="2" id="td_8cbd_13"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 2px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"
                                        ...
                                        <table width="auto" border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td valign="top" id="td_8cbd_14" class="full-block"
                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;padding-left: 10px;padding-right: 10px;padding-top: 10px;padding-bottom: 10px;">
                                                    <table width="auto" border="0" align="center" cellpadding="0"
                                                           cellspacing="0" id="table_8cbd_10"
                                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #6dabdb;border-radius: 3px;margin: 0px auto;">
                                                        <tbody>
                                                        <tr>

                                                            <td width="auto" align="center" valign="middle" height="40"
                                                                id="td_8cbd_15"
                                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #ffffff;font-weight: normal;text-align: center;background-clip: padding-box;padding-left: 32px;padding-right: 32px;word-break: break-word;line-height: 22px;">
                                                                <a href="{blog_url}" id="a_8cbd_1"
                                                                   style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-style: none;font-weight: 400;color: #ffffff;text-decoration: none !important;">
                                                                    Navštíviť stránku
                                                                </a>
        ...
        if (count($aEventsUpcomingWeek) > 0) :
            ...
            <tr>
                <td align="center" valign="top" class="container" id="td_8cbd_22" bgcolor="#eef0f3"
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                           id="table_8cbd_14"
                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #ff7e00;min-width: 600px;width: 600px;margin: 0px auto;">
                        <tbody>
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_15"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" id="td_8cbd_24"
                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 300;text-align: left;word-break: break-word;line-height: 22px;">
                                            <div style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;">
                              <span id="span_8cbd_2"
                                    style="text-decoration: none;color: #ffffff;line-height: 44px;font-size: 36px;">
                                  <?php echo $theme_options['theme_title_by_dates']; ?>
                                    ...
                                    <tr>
                                        <td valign="top" height="4" id="td_8cbd_26"
                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 4px;font-size: 0px;line-height: 0;">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                        ...
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_18"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
                                        <td valign="top" class="image-full-width" width="560" id="td_8cbd_28"
                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 560px;">
                                            <img src="<?php echo $theme_url; ?>/images/shadow-space2.png" width="560"
                                                 alt="shadow-space" id="img_8cbd_2" border="0" hspace="0" vspace="0"
                                                 style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 560px;height: auto !important;display: block !important;">
                                        </td>
                                    </tr>
                                    <tr>
...
//     $image = get_the_post_thumbnail( null );
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" class="image-full-width" width="600"
                                                ...
                                                <a target="_blank" href="<?php echo get_permalink($post); ?>"
                                                   style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;text-decoration: none !important;">
                                                    <img src="<?php echo $image; ?>" width="600" id="img_8cbd_3"
                                                         alt="image"
                                                         border="0" hspace="0" vspace="0" height="auto"
                                                         style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 600px;width: 600px;height: auto !important;border: 0 !important;display: block !important;">
                                                </a>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_23"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                            <td valign="top" height="20" id="td_8cbd_34"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 20px;font-size: 0px;line-height: 0;">
                                                &nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" id="td_8cbd_35"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 300;text-align: left;word-break: break-word;line-height: 22px;">
                                                <div id="div_8cbd_1"
                                                     style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;text-align: left;font-size: 14px;font-weight: 300;">
                                    ...
                                    <br style="line-height: 100%;">
                                        ...
                                        <tr>
                                            <td valign="top"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                                <table width="auto" border="0" align="center" cellpadding="0"
                                                       cellspacing="0" id="table_8cbd_24"
                                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                                    <tbody>
                                                    <tr>
                                                        <td style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_26"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="top" align="center"
                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0"
                                                       cellspacing="0" id="table_8cbd_27"
                                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                                    <tbody>
                                                    <tr>
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 25%;">
                                                            <table width="auto" border="0" align="left" cellpadding="0"
                                                                   cellspacing="0" id="table_8cbd_28"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0 auto;">
                                                                <tbody>
                                                                <tr>
                                                                    <td class="clear-pad" valign="top" id="td_8cbd_40"
                                                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;padding-left: 5px;padding-right: 5px;padding-top: 10px;padding-bottom: 10px;">
                                                                        <table width="auto" border="0" align="center"
                                                                            ...
                                                                            <tr>
                                                                                <td valign="middle" width="18"
                                                                                    id="td_8cbd_41"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 18px;">
                                                                                </td>
                                                                                <td valign="middle" id="td_8cbd_42"
                                                                                    width="14"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;padding-right: 10px;width: 14px;">
                                                                                    <img src="<?php echo $theme_url; ?>/images/icon-arrow.png"
                                                                                         width="14" id="img_8cbd_4"
                                                                                         alt="icon-arrow" border="0"
                                                                                         hspace="0" vspace="0"
                                                                                         style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 14px;height: auto !important;display: block !important;">
                                                                                </td>
                                                                                <td width="auto" align="center"
                                                                                    valign="middle" height="40"
                                                                                    id="td_8cbd_43"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #ffffff;font-weight: normal;text-align: center;background-clip: padding-box;padding-right: 18px;word-break: break-word;line-height: 22px;">
                                                        ...
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 0;">
                                                            <table width="1" border="0" cellpadding="0" cellspacing="0"
                                                                   align="left" class="full-width" id="table_8cbd_30"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0px;min-width: 1px;height: 1px;width: 1px;">
                                                                <tbody>
                                                                <tr>
                                                                    <td height="1" width="1" class="h-20"
                                                                        id="td_8cbd_44"
                                                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;display: block;width: 1px;height: 1px;font-size: 0px;line-height: 0;">
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 74%;">
                                                            <table width="auto" align="right" border="0" cellpadding="0"
                                                                   cellspacing="0" id="table_8cbd_31" class="full-width"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0 auto; width: 100%;">
                                                                <tbody>
                                                                <tr>
                                                                    <td valign="middle"
                                                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 50%;">
                                                                        <table width="100%" align="center" border="0"
                                                                               cellpadding="0" cellspacing="0"
                                                                               id="table_8cbd_32"
                                                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;border-right: 1px solid rgb(231, 233, 236);padding-left: 20px;padding-right: 20px;margin: 0px auto;">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td width="auto" align="right"
                                                                                    valign="top"
                                                                                    id="td_8cbd_45"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 600;background-clip: padding-box;text-align: right;word-break: break-word;line-height: 22px;">
                                                                                    <div style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;">
                                                                                        ↗ &nbsp;<?php echo $strStart; ?>
                                                                                        <br
                                                                    ...
                                                                    <td valign="middle"
                                                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 49%;">
                                                                        <table width="100%" align="center" border="0"
                                                                               cellpadding="0" cellspacing="0"
                                                                               id="table_8cbd_33"
                                                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;border-right: 1px solid rgb(231, 233, 236);padding-left: 20px;padding-right: 20px;margin: 0px auto;">
                                                                            ...
                                                                            <tr>
                                                                                <td width="auto" align="left"
                                                                                    valign="top"
                                                                                    id="td_8cbd_46"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: 600;background-clip: padding-box;text-align: left;word-break: break-word;line-height: 22px;">
                                                                                    <div style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;">
                                                                                        <?php echo $strVenue; ?>
                                                                                    </div>
                                                                                </td>
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_35"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                            <td valign="top" class="image-full-width" width="560" id="td_8cbd_49"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 560px;">
                                                <img src="<?php echo $theme_url; ?>/images/shadow-space.png" width="560"
                                                     alt="shadow-space" id="img_8cbd_5" border="0" hspace="0" vspace="0"
                                                     style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 560px;height: auto !important;display: block!important;">
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                        ...
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_37"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td valign="top" height="27" id="td_8cbd_54"
                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 27px;font-size: 0px;line-height: 0;">
                                            &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                        ...
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_40"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                        ...
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_43"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
                                        <td valign="top" class="image-full-width" width="560" id="td_8cbd_62"
                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 560px;">
                                            <img src="<?php echo $theme_url; ?>/images/shadow-space2.png" width="560"
                                                 alt="shadow-space" id="img_8cbd_6" border="0" hspace="0" vspace="0"
                                                 style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 560px;height: auto !important;display: block !important;">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" class="image-full-width" width="600"
                                                ...
                                                <a target="_blank" href="<?php echo get_permalink($post); ?>"
                                                   style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;text-decoration: none !important;">
                                                    <img src="<?php echo $image; ?>" width="600" id="img_8cbd_7"
                                                         alt="image"
                                                         border="0" hspace="0" vspace="0" height="auto"
                                                         style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 600px;width: 600px;height: auto !important;border: 0 !important;display: block !important;">
                                                </a>
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_48"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                    ...
                                    <br style="line-height: 100%;">
                                        ...
                                        <tr>
                                            <td valign="top"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                                <table width="auto" border="0" align="center" cellpadding="0"
                                                       cellspacing="0" id="table_8cbd_49"
                                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                                    <tbody>
                                                    <tr>
                                                        <td style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_51"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td valign="top" align="center"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                                <table width="100%" align="center" border="0" cellpadding="0"
                                                       cellspacing="0" id="table_8cbd_52"
                                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                                    <tbody>
                                                    <tr>
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 25%;">
                                                            <table width="auto" border="0" align="left" cellpadding="0"
                                                                   cellspacing="0" id="table_8cbd_53"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0 auto;">
                                                                <tbody>
                                                                <tr>
                                                                    <td class="clear-pad" valign="top" id="td_8cbd_74"
                                                                        ...
                                                                        <table width="auto" border="0" align="center"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td valign="middle" id="td_8cbd_76"
                                                                                    width="14"
                                                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;padding-right: 10px;width: 14px;">
                                                                                    <img src="<?php echo $theme_url; ?>/images/icon-arrow.png"
                                                                                         width="14" id="img_8cbd_8"
                                                                                         alt="icon-arrow" border="0"
                                                                                         hspace="0" vspace="0"
                                                                                         style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 14px;height: auto !important;display: block !important;">
                                                                                </td>
                                                        ...
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 0;">
                                                            <table width="1" border="0" cellpadding="0" cellspacing="0"
                                                                   align="left" class="full-width" id="table_8cbd_55"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0px;min-width: 1px;height: 1px;width: 1px;">
                                                                <tbody>
                                                                <tr>
                                                                    <td height="1" width="1" class="h-20"
                                                        ...
                                                        <td valign="middle" class="full-block"
                                                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse; width: 74%;">
                                                            <table width="auto" align="right" border="0" cellpadding="0"
                                                                   cellspacing="0" id="table_8cbd_56" class="full-width"
                                                                   style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0 auto; width: 100%;">
                                                                <tbody>
                                                                <tr>
                                                                    <td valign="middle"
                        ...
                        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                            ...
                            <tr>
                                <td valign="top" align="center"
                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                    <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                           class="full-width" id="table_8cbd_60"
                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                        <tbody>
                                        <tr>
                                            <td valign="top" class="image-full-width" width="560" id="td_8cbd_83"
                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;width: 560px;">
                                                <img src="<?php echo $theme_url; ?>/images/shadow-space.png" width="560"
                                                     alt="shadow-space" id="img_8cbd_9" border="0" hspace="0" vspace="0"
                                                     style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 560px;height: auto !important;display: block!important;">
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                        ...
                        <tr>
                            <td valign="top" align="center"
                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                       class="full-width" id="table_8cbd_62"
                                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;table-layout: fixed;width: 560px;margin: 0px auto;">
                                    <tbody>
                                    <tr>
        ...
        <tr>
            <td align="center" valign="top" class="container" id="td_8cbd_90" bgcolor="#323537"
                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;background-color: #323537;">
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
                       id="table_8cbd_64"
                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;min-width: 600px;background-color: #323537;width: 600px;margin: 0px auto;">
                    <tbody>
                    <tr>
                        <td valign="top" align="center"
                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                            <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" height="21" id="td_8cbd_91"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 21px;font-size: 0px;line-height: 0;">
                                        &nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle"
                                        ...
                                        <table width="auto" align="right" border="0" cellpadding="0" cellspacing="0"
                                               class="full-width-center" id="table_8cbd_66"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                                            <tbody>
                                            <tr>
                                                <td align="right" id="td_8cbd_92"
                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #888888;font-weight: normal;text-align: right;word-break: break-word;line-height: 22px;">
                                                    <div id="div_8cbd_2"
                                                         style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;font-weight: 400;text-decoration: none;color: #ffffff;">
                                                        &nbsp;&nbsp;
                                                        <a href="{profile_url}" id="a_8cbd_4"
                                                           style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-style: none;line-height: 21px;font-size: 13px;color: #ffffff;text-decoration: none !important;">
                                                            Odhlásiť sa
                                                        </a>
                                                    </div>
                                                </td>
                                        ...
                                        <table width="auto" align="left" border="0" cellpadding="0" cellspacing="0"
                                               class="full-width-center" id="table_8cbd_68"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                                            <tbody>
                                            <tr>
                                                <td valign="middle"
                                                    ...
                                                    <table width="auto" align="center" border="0" cellpadding="0"
                                                           cellspacing="0" id="table_8cbd_69"
                                                           style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;margin: 0px auto;">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" valign="middle" id="td_8cbd_94"
                                                                width="25"
                                                                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;padding-left: 3px;padding-right: 3px;width: 25px;">
                                                                <a href="https://www.facebook.com/salsaruedadance/"
                                                                   target="_blank" id="a_8cbd_5"
                                                                   style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;font-size: inherit;border-style: none;text-decoration: none !important;">
                                                                    <img src="<?php echo $theme_url; ?>/images/fb-logo.png"
                                                                         width="25" alt="facebook" id="img_8cbd_10"
                                                                         height="auto"
                                                                         style="line-height: 100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 25px;height: auto !important;border: 0 !important;display: block !important;">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                ...
                                <tr>
                                    <td valign="top" height="18" id="td_8cbd_95"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 18px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                        <div id="div_8cbd_3"
                                             style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;text-align: left;font-size: 13px;font-weight: 400;text-decoration: none;line-height: 21px;color: #ffffff;">
                                            Chcete pridať udalosť? Pošlite nám link Facebook udalosti na náš Facebook
                                            profil. Ďakujeme.
                                        </div>
                                        <!--NLSUBSCRIBE-->
                                    </td>
        ...
        <tr>
            <td valign="top" align="center" id="td_8cbd_97" class="container" bgcolor="#121212"
                style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;background-color: #121212;">
                <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" id="table_8cbd_70"
                       class="container"
                       style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;background-color: #121212;min-width: 600px;width: 600px;margin: 0px auto;">
                    <tbody>
                    <tr>
                        <td valign="top" align="center"
                            style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                            <table width="560" align="center" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" height="6" id="td_8cbd_98"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 6px;font-size: 0px;line-height: 0;">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="center"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;">
                                        <table width="auto" align="left" border="0" cellspacing="0" cellpadding="0"
                                               class="full-width-center" id="table_8cbd_72"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                                            <tbody>
                                            <tr>
                                                <td align="left" id="td_8cbd_99"
                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;font-size: 14px;color: #ffffff;font-weight: normal;text-align: left;word-break: break-word;line-height: 22px;">
                                                    <div style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;">
                                                        <a href="{blog_url}" id="a_8cbd_6"
                                                           style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;color: #999999;border-style: none;text-decoration: none !important;">
                                        ...
                                        <table width="20" border="0" cellpadding="0" cellspacing="0" align="left"
                                               class="full-width" id="table_8cbd_73"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0px;height: 1px;width: 20px;">
                                            <tbody>
                                            <tr>
                                        ...
                                        <td valign="top">
                                        <![endif]-->
                                        <table width="auto" align="right" border="0" cellspacing="0" cellpadding="0"
                                               class="full-width-center" id="table_8cbd_74"
                                               style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                                            <tbody>
                                            <tr>
                                                <td align="right" id="td_8cbd_101"
                                                    style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;color: #999999;font-weight: normal;text-align: right;word-break: break-word;line-height: 22px;font-size: 14px;">
                                                    <div style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;">
                                ...
                                <tr>
                                    <td valign="top" height="19" id="td_8cbd_102"
                                        style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;border-collapse: collapse;height: 19px;font-size: 0px;line-height: 0;">
                                        &nbsp;
                                    </td>
                                </tr>
                                </tbody>
...
//         echo " and removed option (2)";
    ...
    foreach ($aFiles as $sFileName) {
        ...
        $aNLFiles[$sHash] = array(
            ...
            "ts:$iModTime" => array(//         "contents"      => file_get_contents($strDirPath . "/" . "$sFileName"),
            ),
        );
    }
  ...
  <body>
    ...
    foreach ($aNLs as $sHash => $aNL) {
        ...
        foreach ($aNL as $key => $val) {
            if (in_array($key, array("title", "theme_options"))) {
                continue;
            }
            if (count($val) < 2) {
                continue;
            ...
            if ($iRowSpan) {
                ...
                foreach ($val as $name => $value) {
                    ...
                    switch ($name) {
                        case 'contents':
                            // nothing //
                            // echo "<strong>$sHash has contents in $key</strong>";
                            break;
                        case 'counts':
    ...
    // $strSummaryContents .= "\n<pre>" . var_export(strlen(json_encode($aNLs)), true) . "</pre>";
    $strSummaryContents .= '
  <body>
</html>';
